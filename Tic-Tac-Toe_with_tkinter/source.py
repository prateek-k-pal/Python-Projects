...
class TicTacToeGame:
    ...
    def is_valid_move(self,move):
        '''Return valid if move is correct and false if the move is not correct'''
    ...
    def process_move(self, move):
        '''Process the current move and check if its a winning move'''
        row, col = move.row, move.col
    ...
    def is_tied(self):
        '''return true if tied and false otherwise'''
        no_winner = not self._has_winner
        played_moves = (
